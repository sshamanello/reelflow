...
const translations = {
  ru: {
    ...
    auth_login_title: "Вход в ReelFlow",
    ...
    landing_hero_subtitle: "ReelFlow — платформа автоматизации контента. Подключи TikTok через официальный OAuth и публикуй видео прямо из браузера.",
    ...
    landing_security_note: "ReelFlow использует официальные OAuth 2.0 API. Ваши токены хранятся в зашифрованном виде. Мы никогда не запрашиваем пароли от платформ.",

    // Dashboard
    dash_title: "Обзор",
    dash_subtitle: "Добро пожаловать в ReelFlow",
    ...
    acc_security_note: "ReelFlow использует официальные OAuth 2.0 API. После подключения ваши токены хранятся в зашифрованном виде. Мы никогда не запрашиваем пароли.",
  ...
  en: {
    ...
    auth_login_title: "Sign in to ReelFlow",
    ...
    landing_hero_subtitle: "ReelFlow is a content automation platform. Connect TikTok via official OAuth and publish videos directly from your browser.",
    ...
    landing_security_note: "ReelFlow uses official OAuth 2.0 APIs. Your tokens are stored encrypted. We never ask for your platform passwords.",

    // Dashboard
    dash_title: "Overview",
    dash_subtitle: "Welcome to ReelFlow",
    ...
    acc_security_note: "ReelFlow uses official OAuth 2.0 APIs. After connecting, your tokens are stored encrypted. We never ask for your passwords.",
