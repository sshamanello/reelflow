...
const translations = {
  ru: {
    ...
    post_cannot_post: "Ваш аккаунт не может публиковать видео. Попробуйте позже.",
    post_video_too_long: "Видео слишком длинное. Максимум {max} сек.",
    post_disclosure: "Рекламный контент",
    post_disclosure_toggle: "Раскрыть рекламный контент",
    post_disclosure_hint: "Укажите, продвигает ли это видео товар, услугу или бренд",
    post_disclosure_required: "Выберите хотя бы один вариант",
    post_disclosure_tooltip: "Укажите, продвигает ли контент вас, третью сторону или обоих",
    post_promotional_label: "Ваше видео будет помечено как «Рекламный контент»",
    post_paid_label: "Ваше видео будет помечено как «Платное партнёрство»",
    post_branded_private_tooltip: "Видимость «Только я» недоступна для рекламного контента",
    post_music_consent_text: "Публикуя видео, вы принимаете условия использования музыки TikTok",
    post_branded_consent_text: "Публикуя видео, вы принимаете политику рекламного контента TikTok и условия использования музыки",
  ...
  en: {
    ...
    post_cannot_post: "Your account cannot post at this time. Please try again later.",
    post_video_too_long: "Video too long. Maximum {max}s allowed.",
    post_disclosure: "Commercial content",
    post_disclosure_toggle: "Disclose commercial content",
    post_disclosure_hint: "Indicate if this video promotes a product, service, or brand",
    post_disclosure_required: "Select at least one option",
    post_disclosure_tooltip: "You need to indicate if your content promotes yourself, a third party, or both",
    post_promotional_label: "Your video will be labeled as 'Promotional content'",
    post_paid_label: "Your video will be labeled as 'Paid partnership'",
    post_branded_private_tooltip: "Branded content visibility cannot be set to private",
    post_music_consent_text: "By posting, you agree to TikTok's Music Usage Confirmation",
    post_branded_consent_text: "By posting, you agree to TikTok's Branded Content Policy and Music Usage Confirmation",
